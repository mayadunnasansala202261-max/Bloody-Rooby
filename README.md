...
![GitHub repo size](https://img.shields.io/github/repo-size/mayadunnasala202261-max/Bloody-Rooby)
![GitHub stars](https://img.shields.io/github/stars/mayadunnasala202261-max/Bloody-Rooby?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/mayadunnasala202261-max/Bloody-Rooby?style=social)
...
|------------|-------------|
| ![b1](b1.PNG) | **Project Structure** – Overview of `index.html`, `style.css`, and `script.js` |
| ![b2](b2.PNG) | **Hosting Dashboard** – InfinityFree dashboard confirming live deployment |
| ![b3](b3.PNG) | **Homepage** – Main page layout with interactive buttons |
| ![b4](b4.PNG) | **Go to Rooby Section** – Navigation to main interactive area |
| ![b5](b5.PNG) | **Select Subject Page** – Users choose categories or topics before starting |
| ![b6](b6.PNG) | **Quiz Completion** – Last stage after 15 questions |
| ![b7](b7.PNG) | **Alien Dance GIF** – Animated interaction demonstrating playful UX |
| ![b8](b8.PNG) | **Full Layout Preview** – Shows design consistency and structure |
